"""
Training script with Full-Dataset Memory Bank (no masks).
Uses ALBEF_MemBankOnly model.

Usage:
    python Retrieval_membank.py \
        --config configs/PS_icfg_pedes_masked.yaml \
        --output_dir output/icfg-pedes-membank \
        --distributed False
"""
...
from models.model_person_search_membank_only import ALBEF_MemBankOnly
...
def main(args, config):
    ...
    # Model
    print("Creating ALBEF_MemBankOnly model")
    model = ALBEF_MemBankOnly(config=config, text_encoder=args.text_encoder, tokenizer=tokenizer)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='output/icfg-pedes-membank')
